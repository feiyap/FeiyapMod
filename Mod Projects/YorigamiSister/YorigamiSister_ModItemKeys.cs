...
namespace YorigamiSister
{
    public static class ModItemKeys
    {
		...
		/// 朱莉安娜羽扇回旋镖
		/// </summary>
        public static string Buff_B_Joon_5 = "B_Joon_5";
		/// <summary>
		/// 夏季促销
		/// 受到的伤害转化为等量的金币。
		/// 这个减益的效果只在黑雾回合到来前有效。
        ...
        public static string SkillEffect_SE_T_S_Joon_5_0 = "SE_T_S_Joon_5_0";
		...
		/// <summary>
		/// 名流燃烧
		/// 如果目标装备栏已满，则额外施加 2 层“拜金主义”。
		/// 否则会根据目标装备的平均品质，展示 3 件随机装备。那之后，可以选择并装备其中 1 件装备，直到战斗结束。
		/// </summary>
        ...
        public static string Skill_S_Joon_5_0 = "S_Joon_5_0";
		/// <summary>
		/// 珠光指虎
		/// 这个技能的伤害按照“自己身上所有装备品质之和”百分比增加（每点品质提升10%）。
		/// </summary>
		...
		/// <summary>
		/// 即将破裂的泡沫
		/// 至多消耗 &a 金币(攻击力的2000%)，施加 &b 保护罩(消耗金币的10%)，持续 2 回合。
		/// </summary>
        public static string Skill_S_Joon_8 = "S_Joon_8";
        public static string Skill_S_Joon_8_0 = "S_Joon_8_0";
		/// <summary>
		/// 「80年代的勒索者」
