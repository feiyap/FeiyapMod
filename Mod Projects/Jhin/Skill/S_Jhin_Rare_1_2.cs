...
namespace Jhin
{
	...
	/// 对处于“无法行动”的敌人造成的伤害翻倍。
	/// </summary>
    public class S_Jhin_Rare_1_2:Skill_Extended, IP_DamageChange_sumoperation
    {
        public override void SkillUseSingle(Skill SkillD, List<BattleChar> Targets)
        {
            Skill tmpSkill = Skill.TempSkill("S_Jhin_Rare_1_3", this.BChar, this.BChar.MyTeam);
            ...
            {
                MasterAudio.PlaySound("SE_Jhin_Rare_1_2", 1f, null, 0f, null, null, false, false);
            }
        }
