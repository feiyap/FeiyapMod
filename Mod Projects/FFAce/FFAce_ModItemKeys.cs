...
namespace FFAce
{
    public static class ModItemKeys
    {
		...
		/// <summary>
		/// 朱雀之怒
		/// 叠加至 3 层时，&user攻击该目标后获得 1 层“赤红之炎”，并额外造成&a点伤害(&user攻击力的150%)，并施加100%成功率的 1 回合眩晕，然后解除该减益。
		/// </summary>
		...
		/// 苍蓝之冰
		/// 攻击单个敌人时，为目标施加1层“霜冻”。
		/// 当“苍蓝之冰”达到 4 层时，在手中生成 1 个“苍蓝之冰”，并解除该增益。
		/// </summary>
        public static string Buff_B_FFAce_5 = "B_FFAce_5";
		/// <summary>
		/// 霜冻
		/// 达到 4 层后，再次受到物理攻击时使目标和目标两边的敌人受到&a点伤害(&user攻击力的120%)；
		...
		/// <summary>
		/// 冰晶共鸣
		/// 攻击单个敌人时，为目标施加 1 层“霜冻”（追加攻击和反击不能触发）。
		/// </summary>
        public static string Buff_B_FFAce_6 = "B_FFAce_6";
		/// <summary>
		/// 凛冬之契
		/// 每次受到伤害时将被施加 1 层“霜冻”（1个回合内最多触发2次）。
		/// </summary>
		...
		/// <summary>
		/// 零式预判
		/// 翻开：从弃牌库中选择 1 个自己的普通技能置入手中，并使其减少 1 点费用。1 个回合中最多触发 2 次该效果。
		/// </summary>
        public static string Skill_S_FFAce_3 = "S_FFAce_3";
		/// <summary>
		/// 命运轮抽
		/// 从手中选择丢弃 2 个技能，然后抽取 2 个技能：
		/// 若抽到的牌中有攻击牌，则使随机队友获得持续 2 回合的“攻击力和治疗力+15%”；
		/// 若丢弃的技能中有艾斯的牌，则额外使艾斯获得持续 2 回合的“攻击力+15%”。
		/// 翻开：展示弃牌库和牌库中所有的自己的普通技能，选择 1 个技能拿到手中并获得相应的【翻开】效果，1 个回合中最多触发 1 次该效果。
		/// </summary>
        public static string Skill_S_FFAce_4 = "S_FFAce_4";
		/// <summary>
		/// 霜月轮转
		/// 可以选择并丢弃手中的 1 个技能，那之后，抽取 1 个技能。
		/// 翻开：不再将本技能放回原位置，而是置入手中，并获得 1 层“苍蓝之冰”。
		/// </summary>
		...
		/// <summary>
		/// 冰晶共鸣
		/// 此技能被丢弃时，拿回手中并使艾斯获得 1 层“苍蓝之冰”。
		/// 翻开：获得1层“苍蓝之冰”，可再次使用固定能力。
		/// </summary>
        public static string Skill_S_FFAce_6 = "S_FFAce_6";
		/// <summary>
		/// 凛冬之契
		/// 此技能被丢弃时，对随机 1 名敌人施加“凛冬之契”减益。
		/// 翻开：在手中生成 1 个“霜月轮转”，使其附带 1回合后弃牌和放逐。
		/// </summary>
		...
		/// 翻开：对所有敌人施加“燎原之契”，并从牌库和弃牌库中选择 1 张自己的非稀有技能，生成其复制，并附带放逐词条。
		/// </summary>
        public static string Skill_S_FFAce_Rare_1 = "S_FFAce_Rare_1";
		/// <summary>
		/// 朱雀刻印
		/// 在艾斯的所有非稀有的专属技能中选择 1 个生成。
		/// 可再次使用固定能力。
