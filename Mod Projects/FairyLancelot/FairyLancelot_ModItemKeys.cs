...
namespace FairyLancelot
{
    public static class ModItemKeys
    {
		...
		/// 防御穿透
		/// </summary>
        public static string Buff_B_FLancelot_0_1 = "B_FLancelot_0_1";
		/// <summary>
		/// 群体回血
		/// </summary>
		...
		/// </summary>
        public static string Buff_B_FLancelot_3 = "B_FLancelot_3";
		/// <summary>
		/// 攻击力提升
		/// </summary>
        public static string Buff_B_FLancelot_3_0 = "B_FLancelot_3_0";
		/// <summary>
		/// 你已完全属于我
		/// 无法对&user施加减益效果。
		/// 无法恢复体力值。
		/// </summary>
        public static string Buff_B_FLancelot_4 = "B_FLancelot_4";
		/// <summary>
		/// 你已完全属于我
		/// </summary>
        public static string Buff_B_FLancelot_4_0 = "B_FLancelot_4_0";
		/// <summary>
		/// 易伤
		/// </summary>
        public static string Buff_B_FLancelot_5 = "B_FLancelot_5";
		/// <summary>
		/// 暴击率提升
		/// </summary>
        public static string Buff_B_FLancelot_5_1 = "B_FLancelot_5_1";
		/// <summary>
		/// 妖精湖的加护
		/// 根据当前回合数，提升2倍的防御力、最大体力值和10倍的减益成功率。
		/// </summary>
        public static string Buff_B_FLancelot_6 = "B_FLancelot_6";
		/// <summary>
		/// 妖精湖的加护（伪）
		/// 根据当前回合数，提升1倍的防御力、最大体力值和5倍的减益成功率。
		/// </summary>
		...
		/// 保护罩
		/// </summary>
        public static string Buff_B_FLancelot_Barrier = "B_FLancelot_Barrier";
		/// <summary>
		/// 邪龙
		/// 特殊形态。
		...
		/// 幻想破灭
		/// </summary>
        public static string Buff_B_FLancelot_Rare_2_0 = "B_FLancelot_Rare_2_0";
		/// <summary>
		/// 兰斯洛特
		/// Passive:
		/// 最大法力值提升 1 点。
		...
		/// </summary>
        public static string Skill_S_FLancelot_6 = "S_FLancelot_6";
		/// <summary>
		/// 光之地平线
		/// 骑士 - 移除所有“舞者”增益。
		...
		/// 切换至“邪龙”形态。
		/// </summary>
        public static string Skill_S_FLancelot_C_1 = "S_FLancelot_C_1";
		/// <summary>
		/// 骑士
		/// 切换至“骑士”形态。
		/// </summary>
        public static string Skill_S_FLancelot_C_2 = "S_FLancelot_C_2";
		/// <summary>
		/// 无法违背的誓约
		/// 兰斯洛特没有阵亡过。
		/// 完成誓约时，增加 1 点好感度。
		/// </summary>
        public static string Skill_S_FLancelot_H_1 = "S_FLancelot_H_1";
		/// <summary>
		/// 无法违背的誓约
		/// 兰斯洛特至少击杀 1 名敌人。
		/// 完成誓约时，增加 2 点好感度。
		...
		/// 完成誓约时，增加 3 点好感度。
		/// </summary>
        public static string Skill_S_FLancelot_H_4 = "S_FLancelot_H_4";
		/// <summary>
		/// 无法违背的誓约
		/// 兰斯洛特不能使用原始费用为 2 的技能。
		/// 完成誓约时，获得 4 点好感度。
		...
		/// </summary>
        public static string Skill_S_FLancelot_Rare_1 = "S_FLancelot_Rare_1";
		/// <summary>
		/// 无垢搏动
		/// 恢复全部体力值。
		/// 展示牌库中所有自己的技能，选择其中 3 个加入手中，并使其费用变为 0。
