...
namespace Mokou
{
	...
	/// </summary>
    public class S_Kaguya_1_Right:Skill_Extended
    {
        ...
        public override void SkillUseSingle(Skill SkillD, List<BattleChar> Targets)
        {
            ...
            BattleSystem.DelayInput(this.Damage2(Targets[0].MyRightCharReturn().MyRightCharReturn()));
            BattleSystem.DelayInput(this.Damage3(Targets[0].MyRightCharReturn().MyRightCharReturn().MyRightCharReturn()));
            return;
        }
