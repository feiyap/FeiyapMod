...
namespace FixUpDownKeyboard
{
    public class FixUpDownKeyboard_ModDefinition:ModDefinition
    {
    ...
    /* //Example
    public class ExampleSkill : CustomSkillGDE<FixUpDownKeyboard_ModDefinition>
    {
