...
namespace FeiyapCyberBoss
{
    public class FeiyapCyberBoss_ModDefinition:ModDefinition
    {
    ...
    /* //Example
    public class ExampleSkill : CustomSkillGDE<FeiyapCyberBoss_ModDefinition>
    {
