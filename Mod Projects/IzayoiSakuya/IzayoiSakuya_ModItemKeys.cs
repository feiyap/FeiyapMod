...
namespace IzayoiSakuya
{
    public static class ModItemKeys
    {
        ...
        public static string SimpleCampDialogue_CampDial_IzayoiSakuya_Trisha = "CampDial_IzayoiSakuya_Trisha";
        public static string SimpleCampDialogue_CampDial_IzayoiSakuya_Miss = "CampDial_IzayoiSakuya_Miss";
        public static string SimpleCampDialogue_CampDial_IzayoiSakuya_Azar = "CampDial_IzayoiSakuya_Azar";
        public static string SimpleCampDialogue_CampDial_IzayoiSakuya_Lian = "CampDial_IzayoiSakuya_Lian";
        public static string SimpleCampDialogue_CampDial_IzayoiSakuya_Pheonix = "CampDial_IzayoiSakuya_Pheonix";
        public static string SimpleCampDialogue_CampDial_IzayoiSakuya_Priest = "CampDial_IzayoiSakuya_Priest";
        public static string SimpleCampDialogue_CampDial_IzayoiSakuya_Iron = "CampDial_IzayoiSakuya_Iron";
        public static string SimpleCampDialogue_CampDial_IzayoiSakuya_Charon = "CampDial_IzayoiSakuya_Charon";
        public static string SimpleCampDialogue_CampDial_IzayoiSakuya_SilverStein = "CampDial_IzayoiSakuya_SilverStein";
        public static string SimpleCampDialogue_CampDial_IzayoiSakuya_Huz = "CampDial_IzayoiSakuya_Huz";
        public static string SimpleCampDialogue_CampDial_IzayoiSakuya_Red = "CampDial_IzayoiSakuya_Red";
        public static string SimpleCampDialogue_CampDial_IzayoiSakuya_Blue = "CampDial_IzayoiSakuya_Blue";
        public static string SimpleCampDialogue_CampDial_IzayoiSakuya_Johan = "CampDial_IzayoiSakuya_Johan";
        public static string SimpleCampDialogue_CampDial_IzayoiSakuya_Ilya = "CampDial_IzayoiSakuya_Ilya";
        public static string SimpleCampDialogue_CampDial_IzayoiSakuya_Patchouli = "CampDial_IzayoiSakuya_Patchouli";
        public static string SimpleCampDialogue_CampDial_IzayoiSakuya_Mokou = "CampDial_IzayoiSakuya_Mokou";
        public static string SimpleCampDialogue_CampDial_IzayoiSakuya_RemiliaScarlet = "CampDial_IzayoiSakuya_RemiliaScarlet";
		...
		/// </summary>
        public static string SkillExtended_SE_Sakuya_7 = "SE_Sakuya_7";
		/// <summary>
		/// 吾刃回归
		/// 费用减少1点、附带迅速。
		/// </summary>
        public static string SkillExtended_SE_Sakuya_7_0 = "SE_Sakuya_7_0";
		/// <summary>
		/// 月魔术
		/// </summary>
