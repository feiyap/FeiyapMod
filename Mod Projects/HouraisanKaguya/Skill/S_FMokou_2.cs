...
namespace HouraisanKaguya
{
	/// <summary>
	/// 「不死鸟附体」
	/// <color=orange>过热：8 - 改为指向所有敌人。</color>
	/// </summary>
    public class S_FMokou_2:Skill_Extended
    {
        public override void SkillUseSingle(Skill SkillD, List<BattleChar> Targets)
        {
            base.SkillUseSingle(SkillD, Targets);
            if (this.BChar.BuffFind("B_Mokou_T_1") && this.BChar.BuffReturn("B_Mokou_T_1", false).StackNum >= 4)
            {
