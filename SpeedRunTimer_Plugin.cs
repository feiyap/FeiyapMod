...
{
    public class SpeedRunTimer_Plugin: ChronoArkPlugin
    {
        public override void Dispose()
        {
            harmony?.UnpatchSelf();
            if (SpeedRunTimer_PluginMonoBehavior.UI != null)
            {
                GameObject.Destroy(SpeedRunTimer_PluginMonoBehavior.UI.gameObject);
            }
        }
        Harmony harmony;
